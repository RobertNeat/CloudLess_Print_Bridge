...
const messages = {
  pl: {
    ...
    'files.deleteCooldown':
      'Usuwanie pliku „{{name}}” w toku, poczekaj chwilę przed ponowną próbą.',
    ...
    'videos.addCamera.baseUrl': 'Adres URL kamery',
    'videos.addCamera.displayName': 'Nazwa wyświetlana',
    'videos.addCamera.location': 'Lokalizacja',
    ...
    'videos.source.menuAria': 'Działania dla źródła {{name}}',
    'videos.editCamera': 'Edytuj kamerę',
    'videos.editCamera.submit': 'Zapisz',
    'videos.editCamera.error': 'Nie udało się zaktualizować kamery.',
    'videos.removeCamera': 'Usuń kamerę',
    'videos.removeCamera.error': 'Nie udało się usunąć kamery.',
    ...
    'videos.record.timelapseInterval': 'Odstęp',
    'videos.record.timelapseDuration': 'Czas trwania',
    'videos.record.timelapseStarted': 'Timelapse został zapisany w bibliotece multimediów.',
    'videos.record.startRecording': 'Nagrywaj',
    'videos.record.recordingDuration': 'Czas nagrania',
    ...
    'videos.record.hoursAriaLabel': 'Godziny',
    'videos.record.minutesAriaLabel': 'Minuty',
    'videos.record.secondsAriaLabel': 'Sekundy',
    'videos.record.zeroDurationHint': 'Czas trwania musi być większy niż 0.',
    ...
    'videos.record.queued': 'Zlecono nagranie {{fileName}}',
    'videos.record.queuedGeneric': 'Zlecono zadanie nagrywania',
    'videos.jobs.filterAria': 'Kolejka zadań nagrywania',
    'videos.jobs.title': 'Kolejka zadań',
    'videos.jobs.sourceFilter': 'Źródło kamery',
    'videos.jobs.empty': 'Brak aktywnych zadań',
    'videos.jobs.running': 'W trakcie',
    'videos.jobs.waiting': 'Oczekuje',
    'videos.jobs.cancel': 'Anuluj zadanie',
  ...
  en: {
    ...
    'files.deleteCooldown':
      'Deleting file "{{name}}" is in progress, please wait before trying again.',
    ...
    'videos.addCamera.baseUrl': 'Camera URL address',
    'videos.addCamera.displayName': 'Display name',
    'videos.addCamera.location': 'Location',
    ...
    'videos.source.online': 'online',
    'videos.source.offline': 'offline',
    'videos.source.menuAria': 'Actions for source {{name}}',
    'videos.editCamera': 'Edit camera',
    'videos.editCamera.submit': 'Save',
    'videos.editCamera.error': 'Could not update the camera.',
    'videos.removeCamera': 'Remove camera',
    'videos.removeCamera.error': 'Could not remove the camera.',
    ...
    'videos.record.timelapseInterval': 'Interval',
    'videos.record.timelapseDuration': 'Duration',
    'videos.record.timelapseStarted': 'Timelapse saved to the media library.',
    'videos.record.startRecording': 'Record',
    'videos.record.recordingDuration': 'Recording duration',
    ...
    'videos.record.hoursAriaLabel': 'Hours',
    'videos.record.minutesAriaLabel': 'Minutes',
    'videos.record.secondsAriaLabel': 'Seconds',
    'videos.record.zeroDurationHint': 'Duration must be greater than 0.',
    ...
    'videos.record.queued': 'Queued recording {{fileName}}',
    'videos.record.queuedGeneric': 'Recording job queued',
    'videos.jobs.filterAria': 'Recording job queue',
    'videos.jobs.title': 'Job queue',
    'videos.jobs.sourceFilter': 'Camera source',
    'videos.jobs.empty': 'No active jobs',
    'videos.jobs.running': 'Running',
    'videos.jobs.waiting': 'Waiting',
    'videos.jobs.cancel': 'Cancel job',
