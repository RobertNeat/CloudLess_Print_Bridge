...
const messages = {
  pl: {
    ...
    'videos.record.timelapseStarted': 'Timelapse został uruchomiony.',
    'videos.record.startRecording': 'Nagrywaj',
    'videos.record.recordingDuration': 'Czas nagrania (s)',
    'videos.record.recordingStarted': 'Nagrywanie zostało uruchomione.',
    'videos.record.recordAudio': 'Nagraj dźwięk',
    'videos.record.audioDuration': 'Czas nagrania (1-20 s)',
    'videos.record.audioStarted': 'Nagrywanie dźwięku zostało uruchomione.',
